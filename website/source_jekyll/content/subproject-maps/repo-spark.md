...
permalink: /listiary/maps/repo-spark/
exclude: true
---
<br>
The [ListiarySpark](https://github.com/listiary/ListiarySpark) repository is the home for the Spark Lib and the Spark CLI. Spark Lib is an administrative layer for managing the Listiary database, and the CLI is a standalone PHP CLI app to do just that on the console.<br>
<br><br>
