---
layout: page
title: Spark v0.5 - Configs
permalink: /listiary/wiki/spark/v05/configs/
exclude: true
---
<br>
...
[`config-test-compiler`](/listiary/wiki/spark/v05/config-test-compiler/) - Test the compiler service for the current config.<br>
<br><br>
