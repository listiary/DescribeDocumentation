---
layout: page
title: 2download_files
permalink: /listiary/wiki/spark/v02/example23/
exclude: true
---
...
### Usage
`php 2download_files.php "/path/to/directory"`<br>
usage (bash) - output to console<br>

`php 2download_files.php "/path/to/directory" > "output.txt"`<br>
usage (bash) - output to file<br>

`php 2download_files.php "/path/to/directory" >> "output.txt"`<br>
usage (bash) - append to file<br>

`php 2download_files.php "/path/to/directory" 2> "errors.txt"`<br>
usage (bash) - capture errors to file<br>

`php 2download_files.php "/path/to/directory" 2>> "errors.txt"`<br>
usage (bash) - append errors to file<br>

`php 2download_files.php "/path/to/directory" > "all_output.txt" 2>&1`<br>
usage (bash) - capture output and errors to file<br>

`php 2download_files.php "/path/to/directory" &> "all_output.txt"`<br>
