...
We are not going to give a documentation of those classes here - anyone interested in that can read the book - "The Definitive ANTLR 4 Reference" or seek various online tutorials and resources. We will simply give an example of basic usage of these classes, the way they are used in the DescribeParser project.
