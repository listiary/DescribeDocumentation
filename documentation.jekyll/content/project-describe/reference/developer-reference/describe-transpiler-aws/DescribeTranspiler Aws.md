...
exclude: true
---
<br>The Describe Compiler AWS is an Amazon Web Services Lambda function project. It is built for hosting the Describe Compiler as a micro-service, in the form of a lambda function. The project is licensed under the AGPL v3 public license.<br>
